...
const transactionsSlice = createSlice({
  ...
  reducers: {
    withdrawal: (state, { payload }) => {
      console.log('This is the amount subtracted: ' +  Number(payload));
      state.balance -= Number(payload);
      console.log('This is the current Balance: ' + state.balance);
      state.history.push({
        type: "withdrawal",
    ...
    deposit: (state, { payload }) => {
      console.log('This is the amount added: ' +  Number(payload));
      state.balance += Number(payload);
      console.log('This is the current Balance: ' + state.balance);
      state.history.push({
        type: "deposit",
