    ...
    <section className="transactions container">
      ...
      <form onSubmit={onTransaction}>
        <div className="form-row">
          ...
          <div>
            <button default name="deposit" onClick={() => dispatch(deposit(amountStr))}>
              Deposit
            </button>
            <button name="withdraw" onClick={() => dispatch(withdrawal(amountStr))}>Withdraw</button>
          </div>
        </div>
        <div className="form-row">
          <label>
          ...
          <button name="transfer" onClick={() => dispatch(transfer(amountStr))}>Transfer</button>
        </div>
      </form>
    </section>
  );
